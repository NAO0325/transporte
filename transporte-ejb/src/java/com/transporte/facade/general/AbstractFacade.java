 ...
 */
package com.transporte.facade.general;

import com.transporte.util.Cadena;
import com.transporte.util.EntityUtil;
...
public abstract class AbstractFacade<T> {
    ...
    protected void beginTransaction() {
        ...
        sess = (org.hibernate.impl.SessionImpl) em_.getDelegate();
    ...
    protected org.hibernate.impl.SessionImpl getSess() {
        return sess;
    }
